...
我的
ubuntu@dev:~/myprojects/translate_html$ translate "<div>my</div><table style='width: 100px;color: blue'>The style property inside the tag  won't be translate</table>"
